...
$(document).ready(function(){
	...
	<jsp:include page="../include/includefile.jsp"></jsp:include>
						...
						<div class="text-center">
                            ...
                            <div class="auth-box card">
								...
								<form:input path="userPassword" class="form-control" />
										<span class="form-bar"></span> <label class="float-label">User Password</label>
								</div>
                                    
                                     <div class="form-group form-default form-static-label col-sm-12">
                                        <form:input path="emailId" type="text" name="mobileNo" class="form-control"/>
                                        <span class="form-bar"></span>
                                        <label class="float-label">Email Id Name</label>
                                    </div>
                                    <div class="form-group form-default form-static-label col-sm-12">
                                        <form:input path="mobileNo" type="text" name="mobileNo" class="form-control"/>
                                        <span class="form-bar"></span>
                                        <label class="float-label">Mobile No</label>
                                    </div>
                                    <div class="form-group form-default form-static-label col-sm-12">
                                        <form:input path="dateOfBirth" type="text" name="dateOfBirth" class="form-control"/>
                                        <span class="form-bar"></span>
